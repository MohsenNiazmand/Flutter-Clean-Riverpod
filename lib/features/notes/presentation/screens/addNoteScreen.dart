...
import 'package:flutter_clean_riverpod/features/notes/presentation/provider/create_note_provider.dart';
import 'package:flutter_clean_riverpod/features/notes/presentation/provider/selected_note_provider.dart';
import 'package:flutter_clean_riverpod/features/notes/presentation/provider/update_note_provider.dart';
...
class AddNoteScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
      ...
      () {
        SchedulerBinding.instance.addPostFrameCallback((_) {
          if (selectedNote != null) {
            ...
            descriptionController.text = selectedNote.content ?? '';
          }
        });
        return null;
      },
    ...
    ref..listen<DataState<HttpResponse<NoteModel?>>>(
      createNoteProvider,
          (previous, current) {
    ...
    ..listen<DataState<HttpResponse<NoteModel?>>>(
      updateNoteProvider,
          (previous, current) {
        if (current is DataSuccess) {
